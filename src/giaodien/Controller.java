...
//            bienDongCK.sinhDoanVan();
        ...
        if(sinhcauComboxBox.getValue().equals("Sinh Câu Chỉ Số Index")){
            ...
            String dir = System.getProperty("user.dir");
            chiSoIndex.setDataList(new DuLieuChiSoIndex().chuyenCSVSangIndexList(dir + "\\BTL_OOP\\src\\dulieu\\vnindexData.csv", "VNINDEX"));
        ...
        if(sinhcauComboxBox.getValue().equals("Sinh Câu Nhà Đầu Tư Nước Ngoài")){
            ...
            String dir = System.getProperty("user.dir");
            nhaDauTu.setDataList(new DuLieuNDTNN().chuyenFileCSVNDTNNSangList( dir+"\\BTL_OOP\\src\\dulieu\\nhaDauTuNuocNgoaiData.csv"));
...
//            nhaDauTu.sinhDoanVan();
        ...
        if(sinhcauComboxBox.getValue().equals("Chứng Khoán Theo Ngày")){
            ...
            String dir = System.getProperty("user.dir");
            theoNgay.datalist = new DuLieuTheoNgay().chuyenCSVSangIndexList(dir + "\\BTL_OOP\\src\\dulieu\\bienDongTheoNgayData.csv");
//          theoNgay.doan.clear();
